    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-12 bg-gradient-to-br from-blue-600 to-blue-800">
        <div className="text-white">
          ...
          <h1 className="text-4xl font-bold mb-6">Start your journey with intelligent sales analytics</h1>
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of businesses using SalesPro to optimize their sales performance and inventory management.
          </p>
